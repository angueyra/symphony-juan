...
classdef AutoRCFigureHandler < FigureHandler
    ...
    methods
        ...
        function obj = AutoRCFigureHandler(protocolPlugin, deviceName, varargin)           
            ip = inputParser;
        ...
        function handleEpoch(obj, epoch)
            if epoch.containsParameter('RCepoch')%just AutoRC epochs
                if isempty(obj.deviceName)
    ...
    %                 meanPlot.data = (meanPlot.data * meanPlot.count + responseData) / (meanPlot.count + 1);
        ...
        function store(obj, hObject, eventData) %#ok<INUSD>
            ...
            for i = 1:numel(plots)
                ...
                set(plots(i).plotHandle(1), 'Color', obj.storedLineColor,'LineWidth',2);
            end
